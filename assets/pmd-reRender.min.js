...
const /*文章授权协议*/conf_licen=`未经许可禁止转载`;
const /*文章授权协议链接*/conf_licen_link=`https://w.xtdmc.top/licen`;
...
const /*启用建站时长计时 [是否启用t/f,年,月,日]*/conf_time=[true,2021,8,9];
const /*左侧边栏·一言*/conf_saying=`服务器仅寒暑假开放哦~`;
const /*左侧边栏·第1格·背景图片*/conf_sidebar_headimg_src=`/image/head.png`;
const   /*左侧边栏·第1格·背景图片描述*/conf_sidebar_headimg_alt=`PotatoL`;
...
const /*在页面底端增加文章脚注，为空不额外添加*/conf_footer=`<small>Copyright © 2025, PotatoL.<br>本站点和服务器与Mojang Studio、Microsoft、网易Netease均没有关联。</small>`;
